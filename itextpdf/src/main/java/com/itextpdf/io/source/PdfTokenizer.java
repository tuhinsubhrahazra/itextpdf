...
public class PdfTokenizer implements Closeable {
     ...
     * @return byte[] for decrypting or for creating {@link String}.
     */
     ...
     * <br>
     * The same as calling {@link #readLineSegment(ByteBuffer, boolean) readLineSegment(input, true)}.
     *
     ...
     *                         If in doubt, use true or overloaded method {@link #readLineSegment(ByteBuffer) readLineSegment(input)}
     * @return true, if something was read or if the end of the input stream is not reached
     * @throws java.io.IOException in case of any reading error
     */
