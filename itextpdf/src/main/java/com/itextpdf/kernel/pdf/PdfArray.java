...
public class PdfArray extends PdfObject implements Iterable<PdfObject> {
    ...
    /**
     * Create a new PdfArray filled with the values in the float[] as {@link PdfNumber}.
     *
    ...
    /**
     * Create a new PdfArray filled with the values in the double[] as {@link PdfNumber}.
     *
     * @param numbers values to be added to this PdfArray
     */
    ...
    /**
     * Create a new PdfArray filled with the values in the int[] as {@link PdfNumber}.
     *
     * @param numbers values to be added to this PdfArray
     */
    ...
    /**
     * Create a new PdfArray filled with the values in the boolean[] as {@link PdfBoolean}.
     *
     ...
     * should be added as {@link PdfName} (true) or as {@link PdfString} (false).
     *
