...
public class PdfCanvasProcessor {
    ...
    /**
     * Gets the {@link Collection} containing all the registered operators strings.
     *
     * @return {@link Collection} containing all the registered operators strings.
     */
    ...
    protected void populateOperators() {
        ...
        if (supportedEvents == null || supportedEvents.contains(EventType.CLIP_PATH_CHANGED)
            ...
            registerContentOperator("f", new PaintPathOperator(PathRenderInfo.FILL, FillingRule.NONZERO_WINDING, false));
            registerContentOperator("F", new PaintPathOperator(PathRenderInfo.FILL, FillingRule.NONZERO_WINDING, false));
            registerContentOperator("f*", new PaintPathOperator(PathRenderInfo.FILL, FillingRule.EVEN_ODD, false));
            registerContentOperator("B", new PaintPathOperator(fillStroke, FillingRule.NONZERO_WINDING, false));
            registerContentOperator("B*", new PaintPathOperator(fillStroke, FillingRule.EVEN_ODD, false));
            registerContentOperator("b", new PaintPathOperator(fillStroke, FillingRule.NONZERO_WINDING, true));
            registerContentOperator("b*", new PaintPathOperator(fillStroke, FillingRule.EVEN_ODD, true));
            registerContentOperator("n", new PaintPathOperator(PathRenderInfo.NO_OP, -1, false));
            registerContentOperator("W", new ClipPathOperator(FillingRule.NONZERO_WINDING));
            registerContentOperator("W*", new ClipPathOperator(FillingRule.EVEN_ODD));
        }
    }
